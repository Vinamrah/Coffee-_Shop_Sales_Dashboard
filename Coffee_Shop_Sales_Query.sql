...
-- Using the database coffee_shop and importing csv file in the database with table name as 'coffee_shop_sales'
USE coffee_shop;
...
-- viewing the modified datatypes of every columns
